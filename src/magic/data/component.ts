...
export const ComponentMagicHandler = CreateMagicHandlerCallback('component', () => (name: string) => (FindComponentByName(name) || FindComponentById(name))?.GetRootProxy().GetNative());
