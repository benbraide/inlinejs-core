...
const code_1 = require("./concepts/code");
...
const resource_2 = require("./magic/data/resource");
...
const wrap_1 = require("./magic/wrap");
const range_1 = require("./magic/range");
function InlineJSCore() {
    (0, inlinejs_1.WaitForGlobal)().then(() => {
        (0, inlinejs_1.GetGlobal)().SetConcept('code', new code_1.CodeConcept);
        (0, inlinejs_1.GetGlobal)().SetConcept('resource', new resource_1.ResourceConcept());
        ...
        (0, wrap_1.WrapMagicHandlerCompact)();
        (0, range_1.RangeMagicHandlerCompact)();
    });
}
