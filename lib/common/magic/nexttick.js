...
function AddNextTickHandler({ componentId, contextElement }, callback) {
    var _a, _b;
    let contexts = {}, { context } = (((_a = (0, inlinejs_1.FindComponentById)(componentId)) === null || _a === void 0 ? void 0 : _a.GetBackend()) || {});
    ...
    (_b = (0, inlinejs_1.FindComponentById)(componentId)) === null || _b === void 0 ? void 0 : _b.GetBackend().changes.AddNextTickHandler(() => {
        let component = (0, inlinejs_1.FindComponentById)(componentId), { context = null, changes = null } = ((component === null || component === void 0 ? void 0 : component.GetBackend()) || {});
