...
const props = {
    ...
    form: ({ componentId, contextElement }) => { var _a; return (_a = (0, inlinejs_1.FindComponentById)(componentId)) === null || _a === void 0 ? void 0 : _a.FindElement(contextElement, el => (el instanceof HTMLFormElement)); },
...
let proxy = null;
exports.DomMagicHandler = (0, inlinejs_1.CreateMagicHandlerCallback)('dom', (_a) => {
    ...
    return (proxy || (proxy = (0, inlinejs_1.CreateInplaceProxy)((0, inlinejs_1.BuildGetterProxyOptions)({
        getter: (prop) => {
            ...
            if (prop === 'siblings') {
                if (!contextElement.parentElement || contextElement === ((_a = (component || (0, inlinejs_1.FindComponentById)(componentId))) === null || _a === void 0 ? void 0 : _a.GetRoot())) {
                    return () => null;
                }
                return (index) => {
                    var _a;
                    let children = [...(((_a = contextElement.parentElement) === null || _a === void 0 ? void 0 : _a.children) || [])];
