...
class EachDirectiveEntry {
    constructor({ componentId, contextElement, keyInCollection, collection, initInfo, key, keyName, valueName }) {
        ...
        this.proxy_ = (0, inlinejs_1.CreateInplaceProxy)((0, inlinejs_1.BuildProxyOptions)({ getter: (prop) => {
                var _a;
                if (prop && props.hasOwnProperty(prop)) {
                    (prop !== 'parent') && ((_a = (0, inlinejs_1.FindComponentById)(componentId)) === null || _a === void 0 ? void 0 : _a.GetBackend().changes.AddGetAccess(`${id}.${prop}`));
                    return props[prop]();
                }
            }, setter: (prop, value) => {
                var _a, _b;
                if (prop === 'value') {
                    ...
                    if (collection) {
                        ...
                        (0, inlinejs_1.AddChanges)('set', `${this.id_}.value`, 'value', (_b = (0, inlinejs_1.FindComponentById)(this.componentId_)) === null || _b === void 0 ? void 0 : _b.GetBackend().changes);
                        return true;
                    }
                }
                return false;
    ...
    Update(collection, key, initInfo, updateDomPosition = true) {
        ...
        if (this.contextElement_ && this.cloneElement_ && document.contains(this.cloneElement_)) {
            ...
            (_d = (_c = (0, inlinejs_1.FindComponentById)(this.componentId_)) === null || _c === void 0 ? void 0 : _c.FindElementScope(this.cloneElement_)) === null || _d === void 0 ? void 0 : _d.Destroy();
            (0, inlinejs_1.ProcessDirectives)({
            ...
            this.cancelTransition_ = (0, inlinejs_1.WaitTransition)({
    ...
    Destroy() {
        ...
        this.contextElement_ && this.cloneElement_ && (0, inlinejs_1.WaitTransition)({
            componentId: this.componentId_,
            contextElement: this.contextElement_,
            target: this.cloneElement_,
            callback: () => {
...
function LoopDirectiveHandler(matchedExpression, keyName, valueName, _a) {
    ...
    const resolvedKey = (((_c = (_b = (0, inlinejs_1.FindComponentById)(componentId)) === null || _b === void 0 ? void 0 : _b.FindElementScope(contextElement)) === null || _c === void 0 ? void 0 : _c.GetKey()) || (0, inlinejs_1.GetDirectiveValue)(contextElement, 'bind:key', ':key') || '');
    ...
    const generateItems = (data, callback) => {
        ...
        const getCurrentKey = (callback) => {
            if (resolvedKey && proxyAccessHandler) {
                UseProxyAccessHandler(componentId, proxyAccessHandler, () => (0, inlinejs_1.EvaluateLater)({ componentId, contextElement, expression: resolvedKey })(callback));
            }
            else {
    ...
    (_e = (_d = (component || (0, inlinejs_1.FindComponentById)(componentId))) === null || _d === void 0 ? void 0 : _d.FindElementScope(contextElement)) === null || _e === void 0 ? void 0 : _e.AddUninitCallback(() => {
        init = null;
        generateArrayItems([]);
    });
    let firstEntry = true;
