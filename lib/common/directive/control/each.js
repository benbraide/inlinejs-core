...
class EachDirectiveEntry {
     ...
     */
    Update(collection, keyInCollection, initInfo, getNewKey, relativeEl) {
        var _a, _b, _c;
        ...
        if (relativeEl) {
            (_a = this.cloneElement_.parentElement) === null || _a === void 0 ? void 0 : _a.insertBefore(this.cloneElement_, relativeEl);
        }
        else {
            // No relative element means it's the last item, so append to the parent.
            (_b = this.cloneElement_.parentElement) === null || _b === void 0 ? void 0 : _b.appendChild(this.cloneElement_);
        }
        ...
        (_c = this.cancelTransition_) === null || _c === void 0 ? void 0 : _c.call(this);
    ...
    const generateItems = (data, callback) => {
        ...
        callback((item, index) => {
            ...
            getCurrentKey((key) => {
                ...
                const validKey = (0, inlinejs_1.GetGlobal)().IsNothing(key) ? index : key;
                if (existingEntry) {
                    // Update the existing entry with the new data and DOM position.
                    existingEntry.Update(data, index, init, () => key, lastClonedElement ? lastClonedElement.nextElementSibling : contextElement.parentElement.firstElementChild);
