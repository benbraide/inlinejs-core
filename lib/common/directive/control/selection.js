...
function CreateSelectionDirectiveHandler(isElse) {
    return (0, inlinejs_1.CreateDirectiveHandlerCallback)((isElse ? 'else' : 'if'), (_a) => {
        ...
        const resolvedComponent = (component || (0, inlinejs_1.FindComponentById)(componentId)), selectionScopeStackEntry = resolvedComponent === null || resolvedComponent === void 0 ? void 0 : resolvedComponent.PeekSelectionScope();
        ...
        let clone = null;
        const insert = () => (0, insert_1.InsertControlClone)({ componentId, contextElement,
            parent: init.parent,
