...
exports.ResourceConcept = void 0;
...
class ResourceConcept {
    ...
    Get_(info, concurrent) {
        return new Promise((resolve, reject) => {
            var _a;
            let getOne = (info) => {
                if (!(0, inlinejs_1.IsObject)(info.additionalAttributes)) {
                    info.additionalAttributes = {};
                }
                if (info.type === 'link') {
                    info.additionalAttributes && (info.additionalAttributes['rel'] = 'stylesheet');
                }
                let path = (0, inlinejs_1.PathToRelative)(info.path, this.origin_);
                if (!path) {
                    return null;
                }
                ...
                let setData = (data) => {
                    ...
                    (_a = this.loadMap_[path].callbacks) === null || _a === void 0 ? void 0 : _a.forEach(callback => (0, inlinejs_1.JournalTry)(callback, 'InlineJS.ResourceConcept.SetData'));
...
exports.ResourceConcept = ResourceConcept;
