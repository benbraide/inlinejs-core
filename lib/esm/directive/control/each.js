...
export class EachDirectiveEntry {
    constructor({ componentId, contextElement, keyInCollection, collection, initInfo, key, keyName, valueName }) {
        ...
        this.proxy_ = CreateInplaceProxy(BuildProxyOptions({
            getter: (prop) => {
                var _a;
                if (prop && props.hasOwnProperty(prop)) {
                    (prop !== 'parent') && ((_a = GetGlobal().GetCurrentProxyAccessStorage()) === null || _a === void 0 ? void 0 : _a.Put(componentId, `${id}.${prop}`));
                    return props[prop]();
                }
            },
            setter: (prop, value) => {
    ...
    Update(collection, keyInCollection, initInfo, getNewKey) {
        ...
        const changes = (_a = FindComponentById(this.componentId_)) === null || _a === void 0 ? void 0 : _a.GetBackend().changes;
    ...
    Destroy() {
        ...
        this.cloneElement_ && ((_c = (_b = FindComponentById(this.componentId_)) === null || _b === void 0 ? void 0 : _b.FindElementScope(this.cloneElement_)) === null || _c === void 0 ? void 0 : _c.Destroy(true)); // Mark for delete - prevent further reactive updates
        const cleanup = () => {
            var _a, _b, _c;
